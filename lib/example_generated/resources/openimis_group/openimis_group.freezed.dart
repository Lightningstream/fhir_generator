...
class _$_OpenimisGroup implements _OpenimisGroup {
  ...
  @override
  String toString() {
    return 'OpenimisGroup(id: $id, implicitRules: $implicitRules, contained: $contained, extension: $extension, modifierExtension: $modifierExtension, active: $active, actual: $actual, name: $name, quantity: $quantity, characteristic: $characteristic, member: $member)';
  }
