...
_$_OpenimisClaimAdministratorPractitioner
    _$$_OpenimisClaimAdministratorPractitionerFromJson(
...
Map<String, dynamic> _$$_OpenimisClaimAdministratorPractitionerToJson(
        _$_OpenimisClaimAdministratorPractitioner instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
