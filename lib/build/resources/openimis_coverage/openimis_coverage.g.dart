...
_$_OpenimisCoverage _$$_OpenimisCoverageFromJson(Map<String, dynamic> json) =>
    _$_OpenimisCoverage(
      ...
      identifier: (json['identifier'] as List<dynamic>)
          ...
          .toList(),
      status: $enumDecode(_$CoverageStatusCodeEnumMap, json['status']),
      ...
      class_: (json['class_'] as List<dynamic>?)
          ...
          .toList(),
      costToBeneficiary: json['costToBeneficiary'] as String?,
    );

Map<String, dynamic> _$$_OpenimisCoverageToJson(_$_OpenimisCoverage instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      ...
      'status': _$CoverageStatusCodeEnumMap[instance.status],
