...
_$_OpenimisSubscription _$$_OpenimisSubscriptionFromJson(
    ...
    _$_OpenimisSubscription(
      ...
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)
          ?.map((e) => Extension.fromJson(e as Map<String, dynamic>))
          .toList(),
      status: $enumDecode(_$SubscriptionStatusCodeEnumMap, json['status']),
...
Map<String, dynamic> _$$_OpenimisSubscriptionToJson(
        _$_OpenimisSubscription instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      ...
      'status': _$SubscriptionStatusCodeEnumMap[instance.status],
      'end': instance.end,
