...
_$_OpenimisEnrolmentOfficerPractitionerRole
    _$$_OpenimisEnrolmentOfficerPractitionerRoleFromJson(
...
Map<String, dynamic> _$$_OpenimisEnrolmentOfficerPractitionerRoleToJson(
        _$_OpenimisEnrolmentOfficerPractitionerRole instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
