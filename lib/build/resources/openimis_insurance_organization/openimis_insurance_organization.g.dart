...
_$_OpenimisInsuranceOrganization _$$_OpenimisInsuranceOrganizationFromJson(
...
Map<String, dynamic> _$$_OpenimisInsuranceOrganizationToJson(
        _$_OpenimisInsuranceOrganization instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
