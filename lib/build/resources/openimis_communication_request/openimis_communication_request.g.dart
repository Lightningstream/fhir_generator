...
_$_OpenimisCommunicationRequest _$$_OpenimisCommunicationRequestFromJson(
    ...
    _$_OpenimisCommunicationRequest(
      ...
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)
          ...
          .toList(),
      status:
          $enumDecode(_$CommunicationRequestStatusCodeEnumMap, json['status']),
      statusReason: CodeableConcept<FeedbackStatusCoding>.fromJson(
          json['statusReason'] as Map<String, dynamic>,
          (value) =>
              FeedbackStatusCoding.fromJson(value as Map<String, dynamic>)),
...
Map<String, dynamic> _$$_OpenimisCommunicationRequestToJson(
        _$_OpenimisCommunicationRequest instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      ...
      'status': _$CommunicationRequestStatusCodeEnumMap[instance.status],
