...
_$_OpenimisLocation _$$_OpenimisLocationFromJson(Map<String, dynamic> json) =>
    _$_OpenimisLocation(
      ...
      identifier: (json['identifier'] as List<dynamic>)
          ...
          .toList(),
      status: $enumDecodeNullable(_$LocationStatusCodeEnumMap, json['status']),
      name: json['name'] as String,
      mode: $enumDecodeNullable(_$LocationModeCodeEnumMap, json['mode']),
      physicalType: CodeableConcept<LocationTypeCoding>.fromJson(
          json['physicalType'] as Map<String, dynamic>,
          (value) =>
              LocationTypeCoding.fromJson(value as Map<String, dynamic>)),
...
Map<String, dynamic> _$$_OpenimisLocationToJson(_$_OpenimisLocation instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      ...
      'status': _$LocationStatusCodeEnumMap[instance.status],
      'name': instance.name,
      'mode': _$LocationModeCodeEnumMap[instance.mode],
