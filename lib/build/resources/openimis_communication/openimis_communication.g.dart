...
_$_OpenimisCommunication _$$_OpenimisCommunicationFromJson(
    ...
    _$_OpenimisCommunication(
      ...
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)
          ?.map((e) => Extension.fromJson(e as Map<String, dynamic>))
          .toList(),
      status: $enumDecode(_$EventStatusCodeEnumMap, json['status']),
...
Map<String, dynamic> _$$_OpenimisCommunicationToJson(
        _$_OpenimisCommunication instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      ...
      'status': _$EventStatusCodeEnumMap[instance.status],
