...
_$_OpenimisEnrolmentOfficerPractitioner
    _$$_OpenimisEnrolmentOfficerPractitionerFromJson(
...
Map<String, dynamic> _$$_OpenimisEnrolmentOfficerPractitionerToJson(
        _$_OpenimisEnrolmentOfficerPractitioner instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
