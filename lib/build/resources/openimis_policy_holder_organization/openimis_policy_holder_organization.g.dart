...
_$_OpenimisPolicyHolderOrganization
    _$$_OpenimisPolicyHolderOrganizationFromJson(Map<String, dynamic> json) =>
        _$_OpenimisPolicyHolderOrganization(
...
Map<String, dynamic> _$$_OpenimisPolicyHolderOrganizationToJson(
        _$_OpenimisPolicyHolderOrganization instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
