...
part of 'openimis_invoice_bill.dart';
...
OpenimisInvoiceBill _$OpenimisInvoiceBillFromJson(Map<String, dynamic> json) {
  return _OpenimisInvoiceBill.fromJson(json);
}

/// @nodoc
class _$OpenimisInvoiceBillTearOff {
  const _$OpenimisInvoiceBillTearOff();

  _OpenimisInvoiceBill call(
      {String? id,
      Meta? meta,
      Uri? implicitRules,
  ...
  OpenimisInvoiceBill fromJson(Map<String, Object?> json) {
    return OpenimisInvoiceBill.fromJson(json);
  }
}

/// @nodoc
const $OpenimisInvoiceBill = _$OpenimisInvoiceBillTearOff();

/// @nodoc
mixin _$OpenimisInvoiceBill {
  ...
  @JsonKey(ignore: true)
  $OpenimisInvoiceBillCopyWith<OpenimisInvoiceBill> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $OpenimisInvoiceBillCopyWith<$Res> {
  factory $OpenimisInvoiceBillCopyWith(
          OpenimisInvoiceBill value, $Res Function(OpenimisInvoiceBill) then) =
      _$OpenimisInvoiceBillCopyWithImpl<$Res>;
  $Res call(
      {String? id,
      Meta? meta,
      Uri? implicitRules,
...
/// @nodoc
class _$OpenimisInvoiceBillCopyWithImpl<$Res>
    implements $OpenimisInvoiceBillCopyWith<$Res> {
  _$OpenimisInvoiceBillCopyWithImpl(this._value, this._then);

  final OpenimisInvoiceBill _value;
  // ignore: unused_field
  final $Res Function(OpenimisInvoiceBill) _then;
...
/// @nodoc
abstract class _$OpenimisInvoiceBillCopyWith<$Res>
    implements $OpenimisInvoiceBillCopyWith<$Res> {
  factory _$OpenimisInvoiceBillCopyWith(_OpenimisInvoiceBill value,
          $Res Function(_OpenimisInvoiceBill) then) =
      __$OpenimisInvoiceBillCopyWithImpl<$Res>;
  @override
  $Res call(
      {String? id,
      Meta? meta,
...
/// @nodoc
class __$OpenimisInvoiceBillCopyWithImpl<$Res>
    extends _$OpenimisInvoiceBillCopyWithImpl<$Res>
    implements _$OpenimisInvoiceBillCopyWith<$Res> {
  __$OpenimisInvoiceBillCopyWithImpl(
      _OpenimisInvoiceBill _value, $Res Function(_OpenimisInvoiceBill) _then)
      : super(_value, (v) => _then(v as _OpenimisInvoiceBill));

  @override
  _OpenimisInvoiceBill get _value => super._value as _OpenimisInvoiceBill;
  ...
  $Res call({
    ...
    return _then(_OpenimisInvoiceBill(
      id: id == freezed
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$_OpenimisInvoiceBill implements _OpenimisInvoiceBill {
  _$_OpenimisInvoiceBill(
      {this.id,
      this.meta,
      this.implicitRules,
      this.language,
  ...
  factory _$_OpenimisInvoiceBill.fromJson(Map<String, dynamic> json) =>
      _$$_OpenimisInvoiceBillFromJson(json);
  ...
  @override
  String toString() {
    return 'OpenimisInvoiceBill(id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension: $extension, modifierExtension: $modifierExtension, identifier: $identifier, status: $status, type: $type, recipient: $recipient, date: $date, participant: $participant, issuer: $issuer, lineItem: $lineItem, totalNet: $totalNet, totalGross: $totalGross, paymentTerms: $paymentTerms, note: $note)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$OpenimisInvoiceBillCopyWith<_OpenimisInvoiceBill> get copyWith =>
      __$OpenimisInvoiceBillCopyWithImpl<_OpenimisInvoiceBill>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_OpenimisInvoiceBillToJson(this);
  }
}

abstract class _OpenimisInvoiceBill implements OpenimisInvoiceBill {
  factory _OpenimisInvoiceBill(
      {String? id,
      Meta? meta,
      Uri? implicitRules,
      LanguagesCode? language,
      ...
      required Money totalGross,
      Markdown? paymentTerms,
      List<Annotation>? note}) = _$_OpenimisInvoiceBill;

  factory _OpenimisInvoiceBill.fromJson(Map<String, dynamic> json) =
      _$_OpenimisInvoiceBill.fromJson;
